...
/* USER CODE BEGIN PV */
uint8_t TxBuffer[1] = {0}; //Function in HAL cannot use bytes. Instead it requires an array.
/* USER CODE END PV */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	uint8_t i = 0; //Variable for iteration
  /* USER CODE END 1 */
  ...
  CS_STROB(); //Latch to display the output data
  HAL_Delay(1000);
  /* USER CODE END 2 */
